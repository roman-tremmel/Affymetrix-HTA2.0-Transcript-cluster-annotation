...
Rational: since some annotations have been changed from release to release and I noticed that different people have been working with the same HTA2.0 gene-level dataset, but with different releases, there must be an easy method to compare the annotations using e.g. a shiny app.   
